...
Suite result: ok. 1 passed; 0 failed; 0 skipped; finished in 59.91ms (15.30ms CPU time)

Ran 2 tests for test/SecureBounty.t.sol:SecureBountyTest
[PASS] testCommitRevealWorks() (gas: 95792)
Traces:
  [95792] SecureBountyTest::testCommitRevealWorks()   
    ├─ [0] VM::prank(ECRecover: [0x0000000000000000000000000000000000000001])
    │   └─ ← [Return]
    ├─ [47285] SecureBounty::commit(0x16279f301bc112664c863524dece4cf44035a45feed27717b5c36f67fd27fc03)     
    │   └─ ← [Stop]
    ├─ [0] VM::roll(12)
    │   └─ ← [Return]
    ├─ [0] VM::prank(ECRecover: [0x0000000000000000000000000000000000000001])
    │   └─ ← [Return]
    ├─ [34568] SecureBounty::reveal("secret42", 0xa05e334153147e75f3f416139b5109d1179cb56fef6a4ecb4c4cbc92a7c37b70)
    │   ├─ [3000] PRECOMPILES::ecrecover{value: 10000000000000000000}(0x)
    │   │   └─ ← [Return] 0x
    │   └─ ← [Stop]
    └─ ← [Stop]

[PASS] testFrontRunRevealFails() (gas: 71916)
Traces:
  [71916] SecureBountyTest::testFrontRunRevealFails() 
    ├─ [0] VM::prank(ECRecover: [0x0000000000000000000000000000000000000001])
    │   └─ ← [Return]
    ├─ [47285] SecureBounty::commit(0x16279f301bc112664c863524dece4cf44035a45feed27717b5c36f67fd27fc03)     
    │   └─ ← [Stop]
    ...
    │   └─ ← [Return]
    ├─ [8462] SecureBounty::reveal("secret42", 0xa05e334153147e75f3f416139b5109d1179cb56fef6a4ecb4c4cbc92a7c37b70)
    │   └─ ← [Revert] Invalid
    └─ ← [Stop]

Suite result: ok. 2 passed; 0 failed; 0 skipped; finished in 65.37ms (14.64ms CPU time)
...
Suite result: ok. 1 passed; 0 failed; 0 skipped; finished in 3.94ms (1.34ms CPU time)

Ran 2 tests for test/SecureSwap.t.sol:SecureSwapTest
[PASS] testExpiredReverts() (gas: 13509)
Traces:
  [13509] SecureSwapTest::testExpiredReverts()
    ├─ [0] VM::warp(101)
    │   └─ ← [Return]
    ├─ [0] VM::prank(ECRecover: [0x0000000000000000000000000000000000000001])
    │   └─ ← [Return]
    ...
    │   └─ ← [Return]
    ├─ [1107] SecureSwap::swapAForB(1000000000000000000 [1e18], 1, 100)
    │   └─ ← [Revert] Expired
000000 [3e22], 1, 2)
    │   ├─ [16061] SimpleToken::transferFrom(SHA-256: [0x0000000000000000000000000000000000000002], SecureSwap: [0xF62849F9A0B5Bf2913b396098F7c7019b51A820a], 30000000000000000000000 [3e22])
    │   │   ├─ emit Transfer(from: SHA-256: [0x0000000000000000000000000000000000000002], to: SecureSwap: [0xF62849F9A0B5Bf2913b396098F7c7019b51A820a], value: 30000000000000000000000 [3e22])
    │   │   └─ ← [Return] true
...
Suite result: ok. 2 passed; 0 failed; 0 skipped; finished in 3.60ms (1.96ms CPU time)

Ran 4 test suites in 2.55s (132.81ms CPU time): 6 tests passed, 0 failed, 0 skipped (6 total tests)